...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![CI](https://github.com/zsh-contrib/zsh-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/zsh-contrib/zsh-aws/actions/workflows/ci.yml)
